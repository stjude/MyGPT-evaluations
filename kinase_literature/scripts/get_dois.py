...
def parse_args():
    ...
    parser.add_argument(
        "--input",
        default="../inputs/kinase_pubmed_pairs.csv",
        help="Input CSV path with a pubmed_id column.",
    )
    parser.add_argument(
        "--output",
        default="../inputs/kinase_pubmed_pairs_with_doi.csv",
        help="Output CSV path. Defaults to ../inputs/kinase_pubmed_pairs_with_doi.csv.",
    )
    parser.add_argument(
        "--batch-size",
        type=int,
